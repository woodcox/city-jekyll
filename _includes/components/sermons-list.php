...
<div class="flex-row justify-center">
  ...
  <a class="flex-tiny ty-half" aria-label="Listen on Spotify" target="_blank" href="https://open.spotify.com/show/7mWlXxRZD74wuyfJzAYMFf">{% include svg/spotify-podcast.svg %}</a>
  <a class="flex-tiny ty-half" aria-label="RSS Feed" target="_blank" href="https://cecleeds.co.uk/sermons.php">{% include svg/rss-feed.svg %}</a>
</div>
