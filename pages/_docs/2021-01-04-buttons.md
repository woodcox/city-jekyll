...
<input type="submit" value="Submit" class="accent-button square-button" disabled />
<input type="button" value="Input" class="disabled-button round-button" disabled/>
<div class="alternate-background padding-top padding-bottom"><a class="muted-button button" disabled href="#buttons">Link</a></div>
